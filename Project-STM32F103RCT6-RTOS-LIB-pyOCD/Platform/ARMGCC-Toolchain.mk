...
# 链接脚本
TOOLCHAIN_LDSCRIPT = Platform/ARMGCC-STM32F103RCTx_FLASH.ld
# 启动文件
TOOLCHAIN_ASM_STARTUP = Platform/ARMGCC-startup_stm32f103xe.s
...
# ############################
# 链接库
TOOLCHAIN_LIBS = -lc -lm -lnosys -larm_cortexM3l_math

TOOLCHAIN_LIBDIR = -LUserApp/Lib/CMSIS/DSP/lib/GCC

TOOLCHAIN_LD_FLAGS = \
	${MCU} -specs=nano.specs \
	-T$(TOOLCHAIN_LDSCRIPT) \
